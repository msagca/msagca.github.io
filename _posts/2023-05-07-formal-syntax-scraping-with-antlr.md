...
> ANTLR syntax highlighting is not currently supported by [Rouge](https://github.com/rouge-ruby/rouge) but it might be in a future release if my [PR](https://github.com/rouge-ruby/rouge/pull/1955) is accepted.
...
![formal_syntax](assets/formal-syntax.svg)
