...
> ANTLR syntax highlighting is not yet supported by [Rouge](https://github.com/rouge-ruby/rouge), but it may be in a future release if my [PR](https://github.com/rouge-ruby/rouge/pull/1955) gets accepted.
...
![](/assets/images/formal-syntax.svg)
